...
//called before each test case (it). Hook?
...
describe('PATCH /todo/:id', () => {
    ...
    it('should clear CompletedAt when todo is completed', (done) => {
        let hexId = todos[1]._id.toHexString();
        let todoText = 'Updated todo text second';
    ...
    it('should login user and return auth token', (done) => {
        ...
        .end((err, res) => {
            ...
            User.findById(users[1]._id).then((user) => {
                expect(user.toObject().tokens[1]).toMatchObject({ //Why its [1]? 2 Tokens generated! But why it's different?
                    access: 'auth',
